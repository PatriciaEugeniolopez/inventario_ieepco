...
<div class="container mt-4">
    <div class="form-container">
        ...
        <form action="{{ route('proveedores.update', $proveedor->id_prov) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" 
                           ...
                           id="nombre_prov" 
                           name="nombre_prov" 
                           value="{{ old('nombre_prov', $proveedor->nombre_prov) }}" 
                           required>
                    @error('nombre_prov')
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" 
                           ...
                           id="numero_ext" 
                           name="numero_ext" 
                           value="{{ old('numero_ext', $proveedor->numero_ext) }}">
                    @error('numero_ext')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="number" 
                           ...
                           id="numero_int" 
                           name="numero_int" 
                           value="{{ old('numero_int', $proveedor->numero_int) }}">
                    @error('numero_int')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" 
                           ...
                           id="municipio" 
                           name="municipio" 
                           value="{{ old('municipio', $proveedor->municipio) }}" 
                           required>
                    @error('municipio')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
